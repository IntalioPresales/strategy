...
$(".prolinks div").hover(
  ...
  $(document).ready(function(){
	...
	$('.prolinks div').click(function(){
		var tab_id = $(this).attr('data-tab');

		$('.prolinks div').removeClass('current');
		$('.tab-content').removeClass('current animated slideInUp');
		

		$(this).addClass('current');
		$("#"+tab_id).addClass('current animated slideInUp');
