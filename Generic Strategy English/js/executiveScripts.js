...
var chart1_options = {
    ...
    xaxis: {
        type: 'category',
        categories: ['Administration', 'Finance', 'Industry', 'Agriculture', 'Central'],
        labels: {
            show: true,
            rotate: -45,
            rotateAlways: false,
...
document.getElementById("chart2-total").textContent = '29 day  ' + (23 - h) + ':' + (60 - m) + ':' + (60 - s) + '';
setInterval(function () {
    d = new Date();
    h = d.getHours();
    m = d.getMinutes();
...
var chart4_options = {
    ...
    series: [{
        name: 'Hospital restoration',
        data: [31, 40, 28, 51, 42, 109, 100]
    }, {
        name: 'Restoration of the radio building',
