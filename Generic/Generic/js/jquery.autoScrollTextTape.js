...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype = {
        ...
        startMoveTextTape() {
            ...
            if(!this.tapeInterval) {
                ...
                this.tapeInterval = setInterval(() => {
                    let txtContainerPosition = parseInt( this.$textContainer.css('right').slice(0, -2), 10 );

                    if(txtContainerPosition > -containersWidthDiff && !this.tapeReverse) {
                        this.$textContainer.css({right: txtContainerPosition - 1})
                    } else {
        ...
        tapeToStartPosition() {
            this.$textContainer.animate({right: 0}, 'slow', () => {
                $(this).css({right: 'auto'});
            });
        },
